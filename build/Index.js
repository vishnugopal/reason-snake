...
var Ext$ReactTemplate = __webpack_require__(34);
var Draw$ReactTemplate = __webpack_require__(35);
var Food$ReactTemplate = __webpack_require__(36);
var Snake$ReactTemplate = __webpack_require__(37);
var World$ReactTemplate = __webpack_require__(38);

var documentEventTarget = Ext$ReactTemplate.Option[/* unsafelyUnwrapOption */1](Ext$ReactTemplate.Option[/* andThen */2]((function (prim) {
            return Js_primitive.null_undefined_to_opt(prim.body);
          }), DocumentRe.asHtmlDocument(document)));

var initialSnake = Snake$ReactTemplate.create(/* :: */[
      /* tuple */[
        10,
        10
      ],
...
var initialFood = Food$ReactTemplate.create(/* tuple */[
      30,
      20
    ]);

var initialWorld = World$ReactTemplate.create(initialSnake, initialFood, /* Right */1);
...
function handleTick() {
  ...
  var newWorld_000 = /* snake */Snake$ReactTemplate.move(oldWorld[/* snake */0]);
  ...
  state[0] = newWorld;
  Draw$ReactTemplate.clearCanvas(/* () */0);
  Draw$ReactTemplate.drawSnake(state[0][/* snake */0]);
  return Draw$ReactTemplate.drawFood(state[0][/* food */1]);
}
...
var Pervasives = __webpack_require__(16);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Curry = __webpack_require__(1);
var NodeRe = __webpack_require__(10);
var DomTypesRe = __webpack_require__(2);
var SlotableRe = __webpack_require__(26);
var ChildNodeRe = __webpack_require__(27);
var Js_primitive = __webpack_require__(4);
var ParentNodeRe = __webpack_require__(11);
var EventTargetRe = __webpack_require__(3);
var NonDocumentTypeChildNodeRe = __webpack_require__(28);
...
var ParentNodeRe = __webpack_require__(11);
var EventTargetRe = __webpack_require__(3);
var DocumentOrShadowRootRe = __webpack_require__(31);
var NonElementParentNodeRe = __webpack_require__(32);
...
var ElementRe = __webpack_require__(25);
var Canvas2dRe = __webpack_require__(29);
var Js_primitive = __webpack_require__(4);
var Ext$ReactTemplate = __webpack_require__(34);
var Cell$ReactTemplate = __webpack_require__(33);

var canvasEl = Ext$ReactTemplate.Option[/* unsafelyUnwrapOption */1](Js_primitive.null_undefined_to_opt(document.getElementById("snake-game")));

var ctx = canvasEl.getContext("2d");

var canvasWidth = Ext$ReactTemplate.Option[/* unsafelyUnwrapOption */1](Ext$ReactTemplate.Option[/* map */0]((function (prim) {
            return prim.offsetWidth;
          }), ElementRe.asHtmlElement(canvasEl)));

var canvasHeight = Ext$ReactTemplate.Option[/* unsafelyUnwrapOption */1](Ext$ReactTemplate.Option[/* map */0]((function (prim) {
...
function drawCell(fillColor, cell) {
  ...
  ctx.fillRect(Cell$ReactTemplate.x(cell) * 10, Cell$ReactTemplate.y(cell) * 10, 10, 10);
...
var create = Cell$ReactTemplate.create;
...
function create(xs) {
  return List.map(Cell$ReactTemplate.create, xs);
}

function move(t) {
  return List.map((function (cell) {
                return Cell$ReactTemplate.create(/* tuple */[
                            Cell$ReactTemplate.x(cell) + 1 | 0,
                            Cell$ReactTemplate.y(cell)
                          ]);
              }), t);
}
